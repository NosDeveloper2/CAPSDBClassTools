...
IF EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_NAME = ''proc_'+@TableName+'_Delete'' AND ROUTINUE_SCHEMA = ''dbo'')
BEGIN
...
'
	...
	-- Get Procedure
	SELECT @getProcDef = '
IF EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_NAME = ''proc_'+@TableName+'_Get'' AND ROUTINUE_SCHEMA = ''dbo'')
BEGIN
...
IF EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_NAME = ''proc_'+@TableName+'_GetAll'' AND ROUTINUE_SCHEMA = ''dbo'')
BEGIN
...
IF EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_NAME = ''proc_'+@TableName+'_Insert'' AND ROUTINUE_SCHEMA = ''dbo'')
BEGIN
...
IF EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_NAME = ''proc_'+@TableName+'_Update'' AND ROUTINUE_SCHEMA = ''dbo'')
BEGIN
